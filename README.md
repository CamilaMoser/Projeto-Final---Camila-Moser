...
<p align= "justify">
Este projeto foi implementado utilizando as técnicas aprendidadas durante todo o curso do programa +praTi, as tecnologias e linguagens aprendidadas no curso, foram utilizadas neste projeto final como: HTML, Css, Javascript e Bootstrap. Foram utilizadas boas práticas de programação e de responsividade do site para diferentes dispositivos
</p>
...
<p align= "justify"> Foi escolhido o framework Bootstrap para a criação dos componentes visuais do site como botões, tipografia, links e menus. Com o framework bootstrap facilita a implementação destes components mantendo um padrão visual e reutilizável</p>
